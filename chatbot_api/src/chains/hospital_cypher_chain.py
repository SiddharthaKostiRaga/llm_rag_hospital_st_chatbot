...
"""The Neo4jGraph object is a LangChain wrapper that allows LLMs to execute queries on Neo4j instance.
Then instantiate graph using Neo4j credentials, and call graph.refresh_schema() to sync any recent changes to instance."""
graph = Neo4jGraph(
...
hospital_cypher_chain = GraphCypherQAChain.from_llm(
    cypher_llm=ChatGroq(temperature=0, model_name=HOSPITAL_CYPHER_MODEL) ,
    qa_llm=ChatGroq(temperature=0, model_name=HOSPITAL_QA_MODEL),
    graph=graph,
    verbose=True,
